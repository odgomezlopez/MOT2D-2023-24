...
{
    // Cached references
    private ActorController enemyController;
    ...
    void Update()
    {
        ...
        else
        {
            ...
            else
            {
                ...
                rb.linearVelocity = direction * enemyController.MovementConfig.movementSpeed;
            }
        }
    ...
    {
        enemyController = GetComponent<ActorController>();
