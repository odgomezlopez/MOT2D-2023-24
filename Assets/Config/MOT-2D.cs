...
public partial class @MOT2D: IInputActionCollection2, IDisposable
{
    ...
    ~@MOT2D()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MOT2D.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, MOT2D.UI.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Inventory.enabled, "This will cause a leak and performance issues, MOT2D.Inventory.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_GameOver.enabled, "This will cause a leak and performance issues, MOT2D.GameOver.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_None.enabled, "This will cause a leak and performance issues, MOT2D.None.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Pause.enabled, "This will cause a leak and performance issues, MOT2D.Pause.Disable() has not been called.");
    }
